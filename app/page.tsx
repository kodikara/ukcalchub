            ...
            <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
              <div className="space-y-4">
                ...
                <p className="text-base leading-7 text-slate-400">
                  The site combines calculators with explainers, current tax-year notes, official source links and a
                  clear editorial policy so users can understand both the result and the assumptions behind it.
                </p>
                <div className="flex flex-wrap gap-3">
                  ...
                  <Link
                    href="/what-is-1257l-tax-code-uk"
                    className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200 transition hover:border-cyan-400/30 hover:text-white"
                  >
                    Open a money guide
                  </Link>
